...
class AutofillInlineMenuContentService {
    constructor() {
        ...
        this.checkPageRisks = () => autofill_inline_menu_content_service_awaiter(this, void 0, void 0, function* () {
            ...
            const pageTopLayerInUse = yield this.getPageTopLayerInUse();
    ...
    observeCustomElements() {
        var _a, _b, _c, _d;
        (_a = this.htmlMutationObserver) === null || _a === void 0 ? void 0 : _a.observe(document.querySelector("html"), { attributes: true });
        (_b = this.bodyMutationObserver) === null || _b === void 0 ? void 0 : _b.observe(document.body, { attributes: true });
        if (this.buttonElement) {
            (_c = this.inlineMenuElementsMutationObserver) === null || _c === void 0 ? void 0 : _c.observe(this.buttonElement, {
                attributes: true,
            });
        }
        if (this.listElement) {
            (_d = this.inlineMenuElementsMutationObserver) === null || _d === void 0 ? void 0 : _d.observe(this.listElement, { attributes: true });
        }
    }
    /**
